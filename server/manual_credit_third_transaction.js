/**
 * APPROVED MANUAL CREDIT — THIRD TRANSACTION (SAME PLAYER, SECOND DEPOSIT)
 * Player: 15f1d00f-69ac-447e-8a69-612090c03308 (same as second player)
 * Phone: +2347010707754
 * Amount: ₦200 (SECOND deposit by same player)
...
async function main() {
  console.log('=== MANUAL CREDIT TRANSACTION (THIRD TRANSACTION - SAME PLAYER) ===\n');
  console.log(`Player: ${PLAYER_ID}`);
  console.log(`Amount: ₦${AMOUNT} (SECOND deposit by same player)`);
  ...
  try {
    ...
    console.log(`  (Note: Balance is ₦${player.balance} from previous credit - now receiving 2nd deposit)`);
    console.log();
    ...
    console.log(`✓ Player ${PLAYER_ID} credited ₦${AMOUNT} (second deposit)`);
    console.log(`✓ Phone: ${player.phone}`);
    console.log(`✓ Reference: ${REFERENCE}`);
    console.log(`✓ New total balance: ₦${finalPlayer?.balance}`);
